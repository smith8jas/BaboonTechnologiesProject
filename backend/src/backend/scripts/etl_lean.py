...
def main():
    ...
    # print(f"  Depreciation (IS):        {fmt_money(latest.income_statement.depreciation_expense)}")
    ...
    # print(f"  Depreciation (CF):        {fmt_money(latest.cash_flow.depreciation_amortization)}")
