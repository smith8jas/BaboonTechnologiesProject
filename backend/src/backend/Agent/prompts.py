...
- Use one consistent span across all tools for the same company and request unless a specific tool or user instruction
  requires a different span.
...
- Make answers data-driven whenever verified tool data is available; cite the relevant figures, periods, and tool-backed
  evidence instead of relying on general qualitative commentary.
